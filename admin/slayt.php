													...
													<div class="row">
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																...
																<textarea   name="slayt_aciklama[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Başlık" required="" value="<?php echo GetTableValue("slayt_aciklama",TABLE,"where slayt_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>"></textarea>
															</div>
														</div>
